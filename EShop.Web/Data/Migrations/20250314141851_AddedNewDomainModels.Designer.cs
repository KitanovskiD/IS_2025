...
namespace EShop.Web.Data.Migrations
{
    ...
    [Migration("20250314141851_AddedNewDomainModels")]
    partial class AddedNewDomainModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EShop.Domain.Domain_Models.ProductInShoppingCart", b =>
                {
                    ...
                    b.Property<Guid?>("AddedShoppingCartMyProperty")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("AddedShoppingCartMyProperty");
            ...
            modelBuilder.Entity("EShop.Domain.Domain_Models.ProductInShoppingCart", b =>
                {
                    b.HasOne("EShop.Domain.Domain_Models.Product", "AddedProduct")
                        .WithMany("AllShoppingCarts")
                        .HasForeignKey("AddedProductId");

                    b.HasOne("EShop.Domain.Domain_Models.ShoppingCart", "AddedShoppingCart")
                        .WithMany("AllProducts")
                        .HasForeignKey("AddedShoppingCartMyProperty");
